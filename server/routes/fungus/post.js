...
router.post('/section/:mongoid', async (req, res) => {
	...
	const sec1 = new Section1({ mongoid: req.user.mongoid, ...req.body.section1 });
	const sec2 = new Section2({ mongoid: req.user.mongoid, ...req.body.section2 });
	const sec3 = new Section3({ mongoid: req.user.mongoid, ...req.body.section3 });
