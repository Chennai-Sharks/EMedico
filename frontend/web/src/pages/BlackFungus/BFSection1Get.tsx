...
import BFSectionTabs from 'pages/BlackFungus/components/BFSectionTabs';
...
const BFSection1GetAllowed: React.FC<any> = () => {
  const classes = useStyles();
  ...
  return (
    ...
    >
      <BFSectionTabs location={location.state} params={params} section={1} />
      <Divider />
